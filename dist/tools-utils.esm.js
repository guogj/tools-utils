...
export { format, getLocal, getSession, getTimestamp, getUrlVal, isArray, isEmpty, isNumber, makeChNumber, makeChTime, makeDuration, parseUrlValToJson, random, removeLocal, removeSession, setLocal, setSession };
